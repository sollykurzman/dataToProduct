      ...
      div(id="sidebar",
        ...
        div(class="container",
          ...
          div(class = "filter-section",
            ...
            selectizeInput(inputId = "departure_airport", label = NULL, choices = NULL, selected = NULL, multiple = FALSE, options = list(placeholder = "California"))
          ),

          h3("Select Dates"),
          div(class = "filter-section",
            dateInput(inputId = "departure_date", NULL),
            dateInput(inputId = "return_date", NULL)
          ),
